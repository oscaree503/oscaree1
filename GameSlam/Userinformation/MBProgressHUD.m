...
//	CGSize labelSize = [label.text sizeWithAttributes:@{NSFontAttributeName:label.font}];
    CGSize labelSize = labelSize = [label.text sizeWithAttributes:@{NSFontAttributeName:label.font}];
    ...
    NSAttributedString *attributedText = [[NSAttributedString alloc] initWithString:detailsLabel.text==nil?@"":detailsLabel.text
                                                                         attributes:@{NSFontAttributeName: detailsLabel.font}];
    CGRect rect1 = [attributedText boundingRectWithSize:maxSize
                                                options:NSStringDrawingUsesLineFragmentOrigin
                                                context:nil];
    CGSize detailsLabelSize = rect1.size;
